...
GST_STYLE_TRANSFER = 'gststyletransfer'
...
def register(plugin):
    ...
    type_to_register = GObject.type_register(GstStyleTransfer)

    # https://lazka.github.io/pgi-docs/#Gst-1.0/classes/Element.html#Gst.Element.register
    return Gst.Element.register(plugin, GST_STYLE_TRANSFER, 0, type_to_register)       
...
register_by_name(GST_STYLE_TRANSFER)